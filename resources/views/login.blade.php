            ...
            <form action="/signin" class="mb-3" method="GET">
              ...
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input type="number" class="form-control" value="234" name="phone" id="basic-icon-default-fullname" placeholder="123 456 789" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                </div>
              </div>
