        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                       <td>
                                  <img height="50" src="https://dashboard.cardy4u.com/public/upload/logodark.png" height="30px"/>
                        </td>
                     ...
                     <tr>
                        <td>
                            <h4>Hi {{ $data1['f_name'] }},</h4>
                        </td>

                    </tr>
                    <tr>
                        <td class="free-text">
                            There's one last step until your account is 100% ready. We need you to update your information.
                        </td>
                    </tr>
                    <tr>
                        <td class="mini-block-container">
                                                ...
                                                <td class="progress-bar">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <!-- STEP ONE -->
                                                            <td class="step">
                                                                <img src="http://s3.amazonaws.com/swu-filepicker/0oYLLViRBKv7a0Lzh6vC_v3_03.jpg" alt="step one" /><br /> Create Account
                                                            </td>

                                                            <!-- STEP TWO -->
                                                            <td class="step active">
                                                                <img src="https://dashboard.cardy4u.com/public/upload/Untitled-1.png" alt="step two" /><br /> Update Info
                                                            </td>

                                                            <!-- STEP THREE -->
                                                            <td class="step">
                                                                <img src="http://s3.amazonaws.com/swu-filepicker/YSTlgtgaTSa897tPTUhl_v3_05.jpg" alt="step three" /> Complete
                                                            </td>
                ...
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td style="padding: 25px 0 25px">
                            <strong>Cardy</strong><br /> Thanks for choosing cardy  <br /> <br /><br />
                        </td>
                    </tr>
                </table>
            </center>
