						...
						<tr>
							<td style="padding:30px;background-color:#ffffff;">
								<h1
									...
									Hi {{$f_name}}</h1>
                                <p style="margin:0;">This is to notify you that your bank account details has been changed successfully <br></br>
								
                                <p style="margin:0;">If you didn't make this request, reset your password <br>
