                            ...
                            <div class="col-sm-12">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <form action="/otherbank-transfer-now" class="mb-3" method="POST">
                                            @csrf
                                            <div class="d-flex mb-2">

                                                <div class="col-7 mb-sm-0 mb-3">
                                                    <h6 class="mb-1">Ref Code</h6>
                                                    <input class="form-control" readonly name="code" value="{{$bank_code}}">
                                                </div>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="col-7 mb-sm-0 mb-3">
                                                    ...
                                                    <input class="form-control" readonly name="bank_name" value="{{$bank_name}}">
                                                </div>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="col-7 mb-sm-0 mb-3">
                                                    ...
                                                    <input class="form-control" readonly name="account_number" value="{{$account_number}}">
                                                </div>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="col-7 mb-sm-0 mb-3">
                                                    ...
                                                    <input class="form-control" readonly name="amount" value="{{$new_amount}}">
                                                </div>
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="col-7 mb-sm-0 mb-3">
                                                    <h6 class="mb-1">Benefeciary Name</h6>
                                                    <input class="form-control" readonly name="acct_name" value="{{$acc_name}}">
