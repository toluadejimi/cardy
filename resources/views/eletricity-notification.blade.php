					...
					<table role="presentation"
						...
						<tr>
							<td style="padding:30px;background-color:#ffffff;">
								...
								<p style="margin:0;">NGN{{number_format($new_amount), 2}}  has left your wallet for Eletricity Token Purchase<br>
							</td>


                            <td style="padding:30px;background-color:#ffffff;">

                                <p style="margin:0;">We sincerly aplogise for the dellay of Eletricity Token, Kindly wait a bit for your Token. <br>
                                </td>
