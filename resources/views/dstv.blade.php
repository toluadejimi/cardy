                            ...
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    @else
                                        ...
                                        <p class="mb-4">
                                        Subscribe for your DSTV on <b>Cardy</b>.
                                ...
                                <div class="d-flex align-items-end row">
                                    <div class="col-sm-9">
                                        <div class="card-body">
                                            ...
                                            <form action="/verify-dstv-cable/" method="GET">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="">Enter Smartcard
                                                                Number</label>
                                                            <input type="number"  required autfocus class="form-control" name="billers_code"
                                                                id="basic-default-fullname" value="" />
                                                        </div>
                                                    </div>


                                                    <input  hidden name="service_id" value="dstv">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <input type="text" class="form-control" readonly name="eletric_company"
                                                        id="basic-default-fullname" hidden value=" " />
